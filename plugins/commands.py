...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Royalbotz'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/anas0089/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/anas0089/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Royalbotz'),
            
        ],
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://github.com/anas0089/VCPlayerBot>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons))
